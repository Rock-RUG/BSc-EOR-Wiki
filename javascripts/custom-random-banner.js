...
function crSvgForLevel(m,size){if(m===3)return crSvg("shield-check-outline",size).replace('<svg ','<svg data-ct-mastery="mastered" ');if(m===2)return crSvg("check-circle-outline",size).replace('<svg ','<svg data-ct-mastery="clear" ');if(m===1)return crSvg("help-circle-outline",size).replace('<svg ','<svg data-ct-mastery="partial" ');if(m===0)return crSvg("close-circle-outline",size).replace('<svg ','<svg data-ct-mastery="unknown" ');return"";}
