...
function lpMasteryIcon(m){if(m===3)return lpMasterySvg("shield-check-outline",18).replace('<svg ','<svg data-ct-mastery="mastered" ');if(m===2)return lpMasterySvg("check-circle-outline",18).replace('<svg ','<svg data-ct-mastery="clear" ');if(m===1)return lpMasterySvg("help-circle-outline",18).replace('<svg ','<svg data-ct-mastery="partial" ');if(m===0)return lpMasterySvg("close-circle-outline",18).replace('<svg ','<svg data-ct-mastery="unknown" ');return"";}
