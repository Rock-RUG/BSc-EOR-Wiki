...
function mwSvgForLevel(m,size){if(m===3)return mwSvg("shield-check-outline",size).replace('<svg ','<svg data-ct-mastery="mastered" ');if(m===2)return mwSvg("check-circle-outline",size).replace('<svg ','<svg data-ct-mastery="clear" ');if(m===1)return mwSvg("help-circle-outline",size).replace('<svg ','<svg data-ct-mastery="partial" ');if(m===0)return mwSvg("close-circle-outline",size).replace('<svg ','<svg data-ct-mastery="unknown" ');return"";}
