...
function mmSvgForLevel(m,size){if(m===3)return mmSvg("shield-check-outline",size).replace('<svg ','<svg data-ct-mastery="mastered" ');if(m===2)return mmSvg("check-circle-outline",size).replace('<svg ','<svg data-ct-mastery="clear" ');if(m===1)return mmSvg("help-circle-outline",size).replace('<svg ','<svg data-ct-mastery="partial" ');if(m===0)return mmSvg("close-circle-outline",size).replace('<svg ','<svg data-ct-mastery="unknown" ');return"";}
